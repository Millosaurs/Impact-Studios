...
import { Code, PenTool, Megaphone, CheckCircle, ArrowRight, Sun, Moon, Camera, Palette, Rocket, Zap } from "lucide-react"
...
const services = [
  ...
  {
    icon: <Megaphone className="h-12 w-12 mb-6" />,
    title: "Digital Marketing",
    description: "Innovative strategies to amplify your online presence and engage your target audience."
  },
  {
  ...
  {
    icon: <Palette className="h-12 w-12 mb-6" />,
    title: "UI/UX Design",
    description: "User-centric design solutions that enhance user experience and drive engagement."
  },
  {
    icon: <Rocket className="h-12 w-12 mb-6" />,
    title: "SEO Optimization",
    description: "Boost your online visibility and climb search engine rankings with our expert SEO services."
  }
]
          ...
          <header className="px-6 h-16 flex items-center justify-center sticky top-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-gray-200 dark:border-white/20">
            <div className="container flex items-center justify-between">
              ...
              <nav className="flex gap-6 items-center">
                ...
                <Link className="text-sm font-medium hover:text-gray-600 dark:hover:text-gray-300 transition-colors" href="#application">
                  Application
                </Link>
                <Link className="text-sm font-medium hover:text-gray-600 dark:hover:text-gray-300 transition-colors" href="#recruit">
                  Recruit
                </Link>
                <ThemeToggle />
              </nav>
              ...
              <div className="container px-4 md:px-6 mx-auto">
                <div className="flex flex-col items-center space-y-8 text-center">
                  ...
                  <div className="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0">
                    ...
                    <Button size="lg" variant="outline" className="glow-effect-outline hover:glow-effect-outline-hover">Explore Services</Button>
                  </div>
                </div>
              </div>
            </motion.section>
